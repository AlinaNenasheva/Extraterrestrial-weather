...
Widget getWeatherContainer(BuildContext context, SolWeatherDto weatherDay) {
  return Container(
    margin: EdgeInsets.only(left: 20.0, right: 20.0, top: 45.0, bottom: 70.0),
      ...
      children: [
        ...
        Row(
          ...
          children: [
            ...
            Image.asset("assets/sunrise.png", color: Colors.white,),
          ],
        ),
        Row(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            ...
            Image.asset("assets/sunset.png", color: Colors.white,),
          ],
        )
      ],
    ),
